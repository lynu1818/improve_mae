...
class Expert(Module):
    def __init__(
        ...
        self.net = Sequential(
            ...
            nn.Dropout(p=expert_dropout, inplace=False),
...
class MoE(Module):
    ...
    def __init__(self,
        ...
        experts = default(experts, lambda: [Expert(dim = dim, hidden_mult = expert_hidden_mult, expert_dropout=expert_dropout) for _ in range(num_experts)])
