...
class HieraDet(nn.Module):
    ...
    def forward(self, x: torch.Tensor, mask = None, return_intermediates: bool = False,) -> List[torch.Tensor]:
...
@pretrained_model({})
def hieradet_tiny_224(**kwdargs):
    return HieraDet(embed_dim=96, num_heads=1, stages=(1, 2, 7, 2), **kwdargs)
